...
class UsuarioControl
{
    ...
    public function traerRoles($data){
        ...
        if (!empty($data['idusuario'])){
            $usuarioRolC = new UsuarioRolControl();
            $list = $usuarioRolC->buscar(['idusuario'=>$data['idusuario']]);
